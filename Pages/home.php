...
<body class="color-background-gray">
          ...
          <li class="mb-1">
            ...
            <div class="collapse" id="home-collapse" style="">
              <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                <li><a href="/" class="rounded">Rawat Inap</a></li>
                <li><a href="#" class="rounded">Rawat Jalan</a></li>
              </ul>
            </div>
          </li>
          <li class="mb-1">
            ...
            <div class="collapse" id="dashboard-collapse">
              <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                <li><a href="#" class="rounded">Pasien</a></li>
                <li><a href="#" class="rounded">Dokter</a></li>
                <li><a href="#" class="rounded">Layanan Medis</a></li>
                <li><a href="#" class="rounded">Rekam Medis</a></li>
                <li><a href="#" class="rounded">Masuk/Keluar</a></li>
              </ul>
            </div>
          </li>
    ...
    <div class="color-gray mr-0">
        ...
        <div class="row pt-25vh" id="navbarCustom">
            <div class="col d-flex flex-row-reverse text-center mt-3 mb-3 mr-5">
                <a href="">
                    <div class="card">
                        <div class="card-body">
